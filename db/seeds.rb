...
unit1=Unit.create(unit_number:5500,property_name:"Chandaria",property_type:"Residential",price:8000,location:"Nairobi",image_url:"https://cdn.pixabay.com/photo/2022/06/21/16/18/orange-7276122__340.jpg",category:"bedsitter",user_id:user1.id,lister_id:lister1.id)
unit2=Unit.create(unit_number:5501,property_name:"Chandaria",property_type:"Residential",price:10000,location:"Nairobi",image_url:"https://cdn.pixabay.com/photo/2022/06/21/16/18/orange-7276122__340.jpg",category:"1bedroom",user_id:user2.id,lister_id:lister1.id)
unit3=Unit.create(unit_number:5502,property_name:"Elgon",property_type:"Residential",price:15000,location:"Nakuru",image_url:"https://cdn.pixabay.com/photo/2022/06/21/16/18/orange-7276122__340.jpg",category:"2bedroom",user_id:user3.id,lister_id:lister2.id)
unit4=Unit.create(unit_number:5503,property_name:"Elgon",property_type:"Hostel",price:10000,location:"Nakuru",image_url:"https://cdn.pixabay.com/photo/2022/06/21/16/18/orange-7276122__340.jpg",category:"3bedroom",user_id:user4.id,lister_id:lister2.id)
